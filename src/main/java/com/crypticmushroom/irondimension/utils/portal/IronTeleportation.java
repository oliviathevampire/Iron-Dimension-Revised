...
public class IronTeleportation {
    private static final IronTeleportation INSTANCE = new IronTeleportation();
    ...
    private void teleport(ServerPlayerEntity player, ServerWorld fromWorld, ServerWorld toWorld, PortalForcer teleporter)
    {
        ...
        if (player.dimension == WorldIronDimension.IRON_DIMENSION)
        {
    ...
    public static IronTeleportation instance()
    {
        return INSTANCE;
    }
}
