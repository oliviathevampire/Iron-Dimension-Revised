...
public class BlocksID {
    ...
    public static void init() {
        ...
        chiselled_ironstone_slab = register("chiselled_ironstone_slab", new BlockIronstoneSlab(chiselled_ironstone.getDefaultState()));
        ...
        smooth_ironstone_slab = register("smooth_ironstone_slab", new BlockIronstoneSlab(smooth_ironstone.getDefaultState()));
        ...
        ironstone_brick_slab = register("ironstone_brick_slab", new BlockIronstoneSlab(ironstone_bricks.getDefaultState()));
