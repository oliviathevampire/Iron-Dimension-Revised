...
public class BlockIronPortal extends PortalBlock {
    ...
    public void onEntityCollision(BlockState stateIn, World worldIn, BlockPos posIn, Entity entityIn)
    {
        if (entityIn instanceof PlayerEntity)
        {
            ...
            ((IEntityPlayerIron) entity).getPlayerIron().setInPortal();
        }
    }
    ...
    public BlockState getStateForNeighborUpdate(BlockState blockState_1, Direction direction_1, BlockState blockState_2, IWorld iWorld_1, BlockPos pos, BlockPos blockPos_2)
    {
        ...
        return !boolean_1 && blockState_2.getBlock() != this && !(new IronPortalSize(iWorld_1, pos, direction$Axis_2)).method_10362() ? Blocks.AIR.getDefaultState() : super.getStateForNeighborUpdate(blockState_1, direction_1, blockState_2, iWorld_1, pos, blockPos_2);
    }
    ...
    public BlockPattern.Result method_10350(IWorld worldIn, BlockPos p_181089_2_)
    {
        ...
        IronPortalSize blockportal$size = new IronPortalSize(worldIn, p_181089_2_, Direction.Axis.X);
        ...
        if (!blockportal$size.isValid())
        {
            ...
            blockportal$size = new IronPortalSize(worldIn, p_181089_2_, Direction.Axis.Z);
        }
