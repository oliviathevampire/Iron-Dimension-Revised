...
public class TeleporterIronDim extends Teleporter {
            ...
            for (int i1 = -128; i1 <= 128; ++i1) {
                ...
                for (int j1 = -128; j1 <= 128; ++j1) {
                    for (BlockPos blockpos1 = blockpos3.add(i1, this.world.getActualHeight() - 1 - blockpos3.getY(), j1); blockpos1.getY() >= 0; blockpos1 = blockpos2) {
                        ...
                        if (this.world.getBlockState(blockpos1).getBlock() == BlocksIDL.iron_dim_portal) {
                            while (this.world.getBlockState(blockpos2 = blockpos1.down()).getBlock() == BlocksIDL.iron_dim_portal) {
                                blockpos1 = blockpos2;
                            }
