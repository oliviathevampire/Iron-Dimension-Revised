...
public class ChunkProviderIronDim implements IChunkGenerator {
    ...
    public void populate(int chunkX, int chunkZ) {
        ...
        if (biome.decorator.generateFalls) {
            ...
            (new WorldGenLakes(Blocks.FLOWING_WATER)).generate(world, rand, new BlockPos(i1, i2, i3));
        }
        ...
        if (rand.nextInt(16) == 0) {
            ...
            if (j2 < 63 || rand.nextInt(5) == 0) {
                (new WorldGenLakes(Blocks.FLOWING_LAVA)).generate(world, rand, new BlockPos(j1, j2, j3));
            }
        }
