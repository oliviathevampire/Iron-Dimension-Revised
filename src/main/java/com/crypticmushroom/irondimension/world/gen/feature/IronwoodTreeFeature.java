...
public class IronwoodTreeFeature extends IronDimensionTreeFeature<DefaultFeatureConfig> {
    private static final BlockState LOG;
    private static final BlockState LEAVES;

    public IronwoodTreeFeature(Function<Dynamic<?>, ? extends DefaultFeatureConfig> function_1, boolean boolean_1) {
    ...
    static {
        LOG = BlocksID.ironwood_log.getDefaultState();
        LEAVES = BlocksID.ironwood_leaves.getDefaultState();
    }
}
