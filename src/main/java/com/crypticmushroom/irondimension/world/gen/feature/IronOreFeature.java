...
public class IronOreFeature extends Feature<IronOreFeatureConfig> {
    public IronOreFeature(Function<Dynamic<?>, ? extends IronOreFeatureConfig> function_1) {
        super(function_1);
    }

    @Override
    public boolean generate(IWorld iWorld_1, ChunkGenerator<? extends ChunkGeneratorConfig> chunkGenerator_1, Random random_1, BlockPos blockPos_1, IronOreFeatureConfig oreFeatureConfig_1) {
        ...
        double double_1 = (double)((float)blockPos_1.getX() + MathHelper.sin(float_1) * float_2);
        double double_2 = (double)((float)blockPos_1.getX() - MathHelper.sin(float_1) * float_2);
        double double_3 = (double)((float)blockPos_1.getZ() + MathHelper.cos(float_1) * float_2);
        double double_4 = (double)((float)blockPos_1.getZ() - MathHelper.cos(float_1) * float_2);
        double double_5 = (double)(blockPos_1.getY() + random_1.nextInt(3) - 2);
        double double_6 = (double)(blockPos_1.getY() + random_1.nextInt(3) - 2);
    ...
    protected boolean generateVeinPart(IWorld iWorld_1, Random random_1, IronOreFeatureConfig oreFeatureConfig_1, double double_1, double double_2, double double_3, double double_4, double double_5, double double_6, int int_1, int int_2, int int_3, int int_4, int int_5) {
        int int_6 = 0;
                                ...
                                for(int int_19 = int_13; int_19 <= int_16; ++int_19) {
                                    ...
                                    if (double_20 * double_20 + double_21 * double_21 + double_22 * double_22 < 1.0D) {
                                        ...
                                        if (!bitSet_1.get(int_20)) {
                                            ...
                                            if (oreFeatureConfig_1.irontarget.getCondition().test(iWorld_1.getBlockState(blockPos$Mutable_1))) {
