...
public class RustyIronwoodTreeFeature extends IronDimensionTreeFeature<DefaultFeatureConfig> {
    private static final BlockState LOG;
    private static final BlockState LEAVES;

    public RustyIronwoodTreeFeature(Function<Dynamic<?>, ? extends DefaultFeatureConfig> function_1, boolean boolean_1) {
    ...
    static {
        LOG = BlocksID.rusty_ironwood_log.getDefaultState();
        LEAVES = BlocksID.rusty_ironwood_leaves.getDefaultState();
    }
}
