...
public class TeleporterIron extends PortalForcer {
    ...
    private final Long2ObjectMap<IronPortalPos> destinationCoordinateCache = new Long2ObjectOpenHashMap<IronPortalPos>(4096);

    public TeleporterIron(boolean portalSpawn, ServerWorld serverIn)
    {
        super(serverIn);
    ...
    public boolean method_8653(Entity entityIn, float rotationYaw)
    {
        ...
        {
            IronPortalPos teleporter$portalposition = this.destinationCoordinateCache.get(l);
            d0 = 0.0D;
        ...
        if (d0 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.put(l, new IronPortalPos(blockpos, this.worldServerInstance.getTime()));
            }
            ...
            for (int j7 = -1; j7 <= 1; ++j7)
            {
                for (int l7 = 1; l7 < 3; ++l7)
                {
                    for (int k8 = -1; k8 < 3; ++k8)
                    {
                        ...
                        boolean flag = k8 < 0;
                        this.worldServerInstance.setBlockState(new BlockPos(k9, k10, k11), flag ? Blocks.IRON_BLOCK.getDefaultState() : Blocks.AIR.getDefaultState());
                    }
                }
            }
        }
        ...
        for (int i8 = 0; i8 < 4; ++i8)
        {
            for (int l8 = 0; l8 < 4; ++l8)
            {
                for (int l9 = -1; l9 < 4; ++l9)
                {
                    ...
                    this.worldServerInstance.setBlockState(new BlockPos(l10, l11, k12), flag1 ? Blocks.IRON_BLOCK.getDefaultState() : iblockstate, flag1 ? 3 : 18);
                }
            }
        }
